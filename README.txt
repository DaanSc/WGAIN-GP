# In this file many files are created. The information of the files is as follows:
0.  datapreprocessing: R-file which concatenates the datasets of 2019 and 2020 and transforms some variables.
...
10. data_loader: File which contain functions which load the data.
